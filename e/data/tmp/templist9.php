    ...
    <div class="screen">
      <div class="slide_container">
        <ul class="rslides" id="slider">
          <li> <a href="http://www.moyublog.com/" target="_blank"><img src="/skin/ecms064/images/bigpic01.jpg"></a> </li>
<li> <a href="http://www.moyublog.com/" target="_blank"><img src="/skin/ecms064/images/bigpic02.jpg"></a> </li>
<li> <a href="http://www.moyublog.com/" target="_blank"><img src="/skin/ecms064/images/bigpic03.jpg"></a> </li>
<li> <a href="http://www.moyublog.com/" target="_blank"><img src="/skin/ecms064/images/bigpic04.jpg"></a> </li>
        </ul>
      </div>
    </div>
  ...
  <div class="sider">
    <div class="right">
      ...
      <div class="subblock">
        ...
        <?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq('news',5,18,0,'','rand()');
if($ecms_bq_sql){
...
?>
      ...
      <div class="subblock">
        ...
        <?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq('news',5,19,0,'','onclick DESC');
if($ecms_bq_sql){
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=sys_ReturnEcmsLoopStext($bqr);
$bqno++;
