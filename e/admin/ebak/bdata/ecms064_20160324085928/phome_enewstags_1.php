...
E_D("replace into `phome_enewstags` values('99','七牛云存储','1','0','0');");
E_D("replace into `phome_enewstags` values('100','静态文件','1','0','0');");
E_D("replace into `phome_enewstags` values('101','Chrome','1','0','0');");
E_D("replace into `phome_enewstags` values('102','翻墙','1','0','0');");
