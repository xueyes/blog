...
<tr class="header"> 
	<td width="41%" height=23><div align="center" class="button blue small" style="margin-right: 5px;">商品名称</div></td>
	<td width="15%"><div align="center" class="button blue small" style="margin-right: 5px;">市场价格</div></td>
	<td width="15%"><div align="center" class="button blue small" style="margin-right: 5px;">优惠价格</div></td>
	<td width="8%"><div align="center" class="button blue small" style="margin-right: 5px;">数量</div></td>
	<td width="21%"><div align="center" class="button blue small" style="margin-right: 5px;">小计</div></td>
</tr>
<?php
