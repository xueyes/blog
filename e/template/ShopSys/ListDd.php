...
?>
<style>
.tableborder td{padding: 8px 0px;}
</style>
<div class="hy_nav" style="margin-bottom: 20px;">
            	<ul>
            		<li><a href="/e/member/card/" class="selected">我的订单</a></li>
                    <li><a href="#ecms" onclick="window.open('/e/ShopSys/buycar/','','width=680,height=500,scrollbars=yes,resizable=yes');" >我的购物车</a></li>
            		<li><a href="/e/ShopSys/address/ListAddress.php"">管理配送方式</a></li>
            	</ul>
            </div>
...
<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" class=tableborder>
    <tr class=header> 
      <td width="5%" height="23"> <div align="center" class="button green small">序号</div></td>
      <td width="17%"><div align="center" class="button green small">编号(点击查看)</div></td>
      <td width="17%"><div align="center" class="button green small">订购时间</div></td>
      <td width="12%"><div align="center" class="button green small">总金额</div></td>
      <td width="14%"><div align="center" class="button green small">支付方式</div></td>
      <td width="28%"><div align="center" class="button green small">状态</div></td>
      <td width="7%"><div align="center" class="button green small">操作</div></td>
    </tr>
<?
$todaytime=time();
$j=0;
