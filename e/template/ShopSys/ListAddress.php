...
<table width="600" border="0" align="center" cellpadding="3" cellspacing="1" class="tableborder">
  <tr>
    ...
    <td width="50%" bgcolor="#FFFFFF"><div align="right" class="button blue small">[<a href="AddAddress.php?enews=AddAddress">增加配送地址</a>]&nbsp;&nbsp;</div></td>
  </tr>
</table>
<br>
<table width="600" border="0" align="center" cellpadding="3" cellspacing="1" class="tableborder">
    <tr class="header">
      <td width="65%" height="23"><div align="center" class="button green small">地址名称</div></td>
      <td width="10%"><div align="center" class="button green small">默认</div></td>
      <td width="25%"><div align="right" class="button green small">操作</div></td>
    </tr>
    <?php
	...
	?>
    <tr bgcolor="#FFFFFF">
      <td height="25"><div align="left"><?=$r['addressname']?></div></td>
