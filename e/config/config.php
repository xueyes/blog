...
$ecms_config['db']['dbusername']='ecms064';	//数据库用户名
$ecms_config['db']['dbpassword']='ecms064';	//数据库密码
$ecms_config['db']['dbname']='ecms064';	//数据库名
...
$ecms_config['esafe']['ecookiernd']='J1Ni3f9SuF6UqR68t5hklvcJ7yTizL';	//后台登录COOKIE认证码(填写10~50个任意字符，最好多种字符组合)
...
$ecms_config['cks']['ckvarpre']='oszrd';		//前台cookie变量前缀
$ecms_config['cks']['ckadminvarpre']='dihje';		//后台cookie变量前缀
$ecms_config['cks']['ckrnd']='40T4LU09UWxk9hh9pRhGqDr106jmAA';	//COOKIE验证随机码(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndtwo']='pTafcGcg2JTXxS30jgEKerUuLKncFQ';	//COOKIE验证随机码2(填写10~50个任意字符，最好多种字符组合)
...
'modmemberedittran'=>0,
'modinfoedittran'=>0,
'deftempid'=>0,'add_xlwb'=>'http://weibo.com/u/2462548165','add_txwb'=>'http://t.qq.com/moyu_blog/','add_icp'=>'鲁ICP备12345678号','add_tongji'=>'','add_duoshuo'=>'ecms064','add_qq'=>'12345678','add_email'=>'12345678@qq.com','add_feed'=>'/e/web/?rss=2','add_gonggao'=>'此网站为墨鱼部落格模板演示网站，此处文字请后台修改！');
//------------e_public
